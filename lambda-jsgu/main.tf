...
resource "aws_lambda_function" "publish_book_review" {
    ...
    runtime = "python3.8"
    function_name = "${var.resourcesuffix}-publish-book-review"
...
resource "null_resource" "sam_metadata_aws_lambda_function_publish_book_review" {
    triggers = {
        resource_name = "${var.resourcesuffix}-aws_lambda_function.publish_book_review"
...
resource "aws_iam_role" "iam_for_lambda" {
  name = "${var.resourcesuffix}-iam_for_lambda"
...
resource "aws_dynamodb_table" "book-reviews-ddb-table" {
  name           = "${var.resourcesuffix}-BookReviews"
...
resource "aws_apigatewayv2_api" "lambda" {
  name          = "${var.resourcesuffix}-book_reviews_service"
  protocol_type = "HTTP"
}
...
resource "aws_apigatewayv2_stage" "lambda" {
  ...
  name        = "${var.resourcesuffix}-serverless_lambda_stage"
  auto_deploy = true
